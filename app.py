...
#                        autocommit=True)
conn = pymysql.connect(host='us-cdbr-iron-east-05.cleardb.net', user='b64f96eb9600a6', password='14fe566b',
                       db='heroku_ca977ac61a4125c', autocommit=True, connect_timeout=2147483)
cur = conn.cursor()
